...
internal object JsonUtil {
    fun parse(json: String?): Any? {
        ...
        return com.coredf.servicebus.SimpleJson.parseValue(json.trim(), intArrayOf(0))
    }

    fun stringify(value: Any?): String = com.coredf.servicebus.SimpleJson.stringify(value)
}
