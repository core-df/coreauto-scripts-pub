...
| Script | Role |
|--------|------|
| `full_integration_step.php` | Core Auto step |
| `full_integration_ingress.php` | Kafka → Collector bridge |

```shell
export CA_EVENT_NAME=OrderInbound KAFKA_BOOTSTRAP_SERVERS=localhost:9092
export EXAMPLE_KAFKA_TOPIC=orders.inbound
php full_integration_ingress.php
```
