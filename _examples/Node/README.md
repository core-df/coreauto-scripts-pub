...
| Script | Role |
|--------|------|
| `full_integration_step.mjs` | Core Auto step |
| `full_integration_ingress.mjs` | Kafka → Collector bridge |

```shell
export CA_EVENT_NAME=OrderInbound KAFKA_BOOTSTRAP_SERVERS=localhost:9092
export EXAMPLE_KAFKA_TOPIC=orders.inbound
node full_integration_ingress.mjs
```
...
node full_integration_step.mjs
```
